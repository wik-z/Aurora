...
namespace Aurora.Profiles.Aurora_Wrapper
{
    public class GameEvent_Aurora_Wrapper : LightEvent
    {
        ...
        internal virtual void UpdateWrapperLights(EffectFrame frame)
        {
            ...
            List<DynamicDeviceLED> allkeys = Global.deviceManager.AllLEDS;
            foreach (var key1 in allkeys)
            {
                DeviceLED key = key1.GetDeviceLED();
        ...
        internal virtual void UpdateWrapperLights(IGameState new_game_state)
        {
            if (new_game_state is GameState_Wrapper)
            {
                ...
                SetExtraKey(KeyboardKeys.LOGO.GetDeviceLED(), ngw_state.Extra_Keys.logo);
                SetExtraKey(KeyboardKeys.LOGO2.GetDeviceLED(), ngw_state.Extra_Keys.badge);

                //TODO: Rework the peripheral light
                //SetExtraKey(KeyboardKeys.Peripheral.GetDeviceLED(), ngw_state.Extra_Keys.peripheral);


                SetExtraKey(KeyboardKeys.G1.GetDeviceLED(), ngw_state.Extra_Keys.G1);
                SetExtraKey(KeyboardKeys.G2.GetDeviceLED(), ngw_state.Extra_Keys.G2);
                SetExtraKey(KeyboardKeys.G3.GetDeviceLED(), ngw_state.Extra_Keys.G3);
                SetExtraKey(KeyboardKeys.G4.GetDeviceLED(), ngw_state.Extra_Keys.G4);
                SetExtraKey(KeyboardKeys.G5.GetDeviceLED(), ngw_state.Extra_Keys.G5);
                SetExtraKey(KeyboardKeys.G6.GetDeviceLED(), ngw_state.Extra_Keys.G6);
                SetExtraKey(KeyboardKeys.G7.GetDeviceLED(), ngw_state.Extra_Keys.G7);
                SetExtraKey(KeyboardKeys.G8.GetDeviceLED(), ngw_state.Extra_Keys.G8);
                SetExtraKey(KeyboardKeys.G9.GetDeviceLED(), ngw_state.Extra_Keys.G9);
                SetExtraKey(KeyboardKeys.G10.GetDeviceLED(), ngw_state.Extra_Keys.G10);
                SetExtraKey(KeyboardKeys.G11.GetDeviceLED(), ngw_state.Extra_Keys.G11);
                SetExtraKey(KeyboardKeys.G12.GetDeviceLED(), ngw_state.Extra_Keys.G12);
                SetExtraKey(KeyboardKeys.G13.GetDeviceLED(), ngw_state.Extra_Keys.G13);
                SetExtraKey(KeyboardKeys.G14.GetDeviceLED(), ngw_state.Extra_Keys.G14);
                SetExtraKey(KeyboardKeys.G15.GetDeviceLED(), ngw_state.Extra_Keys.G15);
                SetExtraKey(KeyboardKeys.G16.GetDeviceLED(), ngw_state.Extra_Keys.G16);
                SetExtraKey(KeyboardKeys.G17.GetDeviceLED(), ngw_state.Extra_Keys.G17);
                SetExtraKey(KeyboardKeys.G18.GetDeviceLED(), ngw_state.Extra_Keys.G18);
                SetExtraKey(KeyboardKeys.G19.GetDeviceLED(), ngw_state.Extra_Keys.G19);
                SetExtraKey(KeyboardKeys.G20.GetDeviceLED(), ngw_state.Extra_Keys.G20);
