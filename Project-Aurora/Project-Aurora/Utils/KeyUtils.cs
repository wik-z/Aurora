...
namespace Aurora.Utils
{
    ...
    public static class KeyUtils
    {
        ...
        public static KeyboardKeys GetDeviceKey(Keys forms_key, int scanCode = 0, bool isExtendedKey = false)
        {
            ...
            //TODO: Fix this for proper layout conversion
        ...
        public static KeyboardKeys GetDeviceKey(this KeyboardInputEventArgs eventArgs)
        {
        ...
        /// <returns>The resulting Devices.DeviceKeys</returns>
        public static KeyboardKeys ToDeviceKeys(CorsairLedId CorsairKey)
        {
            switch (CorsairKey)
            {
