...
namespace Aurora.Settings.Layers
{
    ...
    public class GradientFillLayerHandler : LayerHandler<GradientFillLayerHandlerProperties>
    {
        ...
        public override EffectLayer Render(IGameState gamestate)
        {
            ...
            Properties.GradientConfig.shift_amount = Properties.GradientConfig.shift_amount % Global.deviceManager.canvas_biggest;
            Properties.GradientConfig.last_effect_call = Utils.Time.GetMillisecondsSinceEpoch();

            Color selected_color = Properties.GradientConfig.brush.GetColorSpectrum().GetColorAt(Properties.GradientConfig.shift_amount, Global.deviceManager.canvas_biggest);
