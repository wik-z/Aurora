...
namespace Aurora.Devices.SteelSeries
{
    ...
    class SteelSeriesDevice : DeviceIntegration
    {
        ...
        public static byte GetHIDCode(DeviceLED key)
        {
            return GetHIDCode(key.LedID, () => Global.deviceManager.GetDeviceFromDeviceLED(key).Properties.GetVariable<KeyboardDeviceLayout.PreferredKeyboardLocalization>("language"));
        }
        ...
        /// <returns></returns>
        public static byte GetHIDCode(short key, Func<KeyboardDeviceLayout.PreferredKeyboardLocalization> lang)
        {
